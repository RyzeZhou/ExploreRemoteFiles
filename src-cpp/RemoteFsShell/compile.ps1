...
$cpps = @("ContextMenu.cpp","Dll.cpp","PropSheet.cpp","RemoteFsShell.cpp","FVCommands.cpp","Utils.cpp")
...
if ($okCount -eq $cpps.Count) {
  ...
  $linkArgs = @("/nologo","/DLL","/OUT:RemoteFsShell.dll","/DEF:RemoteFsShell.def","/MACHINE:X64") + $objs + @("RemoteFsShell.res","propsys.lib","user32.lib","shell32.lib","ole32.lib","oleaut32.lib","advapi32.lib","uuid.lib","comctl32.lib")
